...
st.set_page_config(page_title="종합 리뷰 분석 시스템", page_icon="🔬", layout="wide")
    ...
    with st.container():
        ...
        if comment["id"] in st.session_state.comprehensive_analysis_results:
            ...
            with st.expander(
                ...
                with st.container():
                    st.markdown(
                        f'<div class="analysis-card {status_class}">',
                        unsafe_allow_html=True,
                    )
                    ...
                    with col1:
                        ...
                        if "confidence" in moderation_result:
                            st.markdown(
                                f"**신뢰도:** {moderation_result['confidence']:.3f}"
                            )
                ...
                if not is_approved:
                    ...
                    if keyword_highlights:
                        for highlight in keyword_highlights:
                            ...
                            st.markdown(
                                f'<div class="highlight-box">', unsafe_allow_html=True
                            )
                    ...
                    st.markdown(
                        f'<div class="analysis-card" style="border-left: 4px solid {sentiment_color};">',
                        unsafe_allow_html=True,
                    )
                    ...
                    st.markdown(
                        f'<div style="background: #f8fafc; padding: 16px; border-radius: 8px; border-left: 3px solid #3b82f6;">{auto_response}</div>',
                        unsafe_allow_html=True,
                    )
                    st.markdown("</div>", unsafe_allow_html=True)
